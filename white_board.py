...
# print("Created by Abhishek Mehata")
...
root = tk.Tk()
root.title("Whiteboard App/ Created by Abhishek Mehata")
...
clear_button = tk.Button(controls_frame, text="Clear Screen", command=lambda: canvas.delete("all"))
